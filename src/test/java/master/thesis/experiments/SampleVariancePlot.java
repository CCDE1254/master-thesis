 ...
 *
 */
public class SampleVariancePlot extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
        	SampleVariancePlot ex = new SampleVariancePlot();
            ex.setVisible(true);
        });
    }
    
    public SampleVariancePlot() {
    ...
    private XYDataset createDataset() {
		...
		XYSeries series1 = new XYSeries("Sample variance under IS");
		for(int i = 0; i < numberOfIterationTimes+1; i++) {
			series1.add(i, importanceSamplingSampleVariances[i]);
		}
		dataset.addSeries(series1);
		

		
		XYSeries series2 = new XYSeries("Sample variance under AIS");
		for(int i = 0; i < numberOfIterationTimes+1; i++) {
			series2.add(i, adaptiveImportanceSamplingSampleVariances[i]);
		}
