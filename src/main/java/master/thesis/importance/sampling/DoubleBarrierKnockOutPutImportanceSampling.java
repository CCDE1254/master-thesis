...
import master.thesis.underlying.UnderlyingPriceUnderISPut;
...
public class DoubleBarrierKnockOutPutImportanceSampling {
	...
	public DoubleBarrierKnockOutPutImportanceSampling(int numberOfSimulations, int numberOfTimeSteps,
	...
	public double[][] getIncrementsMatrixUnderProposalDistribution() {
		UnderlyingPriceUnderISPut underlyingPrice = new UnderlyingPriceUnderISPut(numberOfSimulations, numberOfTimeSteps,
				randomNumberMatrix,
