 ...
 *
 */
public class DoubleBarrierKnockOutPutMonteCarlo {
	...
	public DoubleBarrierKnockOutPutMonteCarlo(double initialStockPrice, double riskFreeRate, double volatilityTerm,
