 ...
 *
 */
public class GradientDescentBackwardAISPut {
	...
	public GradientDescentBackwardAISPut(int numberOfSimulations, int numberOfTimeSteps, int numberOfFirstHiddenLayerNeurons,
	...
	public double[][] getOptimalNaturalParameterUnderBackwardAIS() {
		...
		for(int c = numberOfTimeSteps-1; c > 0 ; c--) {
			NeuralNetworkForwardAISPut neural = new NeuralNetworkForwardAISPut(numberOfSimulations, numberOfTimeSteps, c, optimizedNaturalParameters , numberOfFirstHiddenLayerNeurons,
