 ...
 *
 */
public class GradientDescentISPut {
	...
	public GradientDescentISPut(int numberOfSimulations, int numberOfTimeSteps, int numberOfFirstHiddenLayerNeurons,
	...
	public double[] getOptimalNaturalParameterUnderIS() {
		NeuralNetworkISPut neural = new NeuralNetworkISPut(numberOfSimulations, numberOfTimeSteps, numberOfFirstHiddenLayerNeurons,
		...
		double[] optimalNaturalParameter = neural.getOutput(weightMatrix1, weightMatrix2, weightMatrix3);
		return optimalNaturalParameter;
	}
