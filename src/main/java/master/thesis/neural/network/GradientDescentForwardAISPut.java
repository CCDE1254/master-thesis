 ...
 *
 */
public class GradientDescentForwardAISPut {
	...
	public GradientDescentForwardAISPut(int numberOfSimulations, int numberOfTimeSteps, int numberOfFirstHiddenLayerNeurons,
